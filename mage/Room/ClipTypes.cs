    ...
    public void DrawCollisionPixel(Bitmap b, RoomPixelImageExportDialogResult options, bool cropped = false)
    {
        ...
        for (int y = startY; y < endY; y++)
            for (int x = startX; x < endX; x++)
            {
                ...
                Color drawColor = options.ColorBackground;
                if (type == 1) drawColor = options.ColorSolid;
    ...
    public Color? GetColorForClipdataPixel(ushort clipVal, RoomPixelImageExportDialogResult options)
    {
        if (Version.IsMF)
        {
            switch (clipVal)
            {
                ...
                case 0x44:
                case 0x45:
                    return options.ColorGreenHatch;
                case 0x46:
                case 0x47:
                case 0x48:
                case 0x49:
                case 0x4A:
                case 0x4B:
                    return options.ColorYellowHatch;
                case 0x50:
                case 0x51:
                case 0x52:
                case 0x53:
                ...
                case 0x6C:
                case 0x6D:
                    return options.ColorShotBlock;
                case 0x54:
                case 0x5E:
                    return options.ColorMissileBlock;
                case 0x55:
                case 0x56:
                case 0x70:
                case 0x71:
                ...
                case 0x76:
                case 0x77:
                    return options.ColorBombBlock;
                case 0x57:
                    return options.ColorPowerBlock;
                case 0x58:
                case 0x6B:
                    return options.ColorSpeedBlock;
                case 0x59:
                    return options.ColorScrewBlock;
                case 0x5A:
                    return options.ColorCrumbleBlock;
            }
        }
        else
        {
            switch (clipVal)
            {
                ...
                case 0x59:
                case 0x69:
                    return options.ColorSuperBlock;
                case 0x5A:
                case 0x6A:
                    return options.ColorSpeedBlock;
                case 0x5B:
