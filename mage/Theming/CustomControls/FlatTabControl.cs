...
namespace mage.Theming.CustomControls
{
    public class FlatTabControl : System.Windows.Forms.TabControl
    {
        ...
        internal void DrawControl(Graphics g)
        {
            ...
            //----------------------------
            // fill client area
            Brush br = new SolidBrush(BackColor); //(SystemColors.Control); UPDATED
        ...
        internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
        {
            ...
            g.DrawPolygon(new Pen(BorderColor), pt);
        ...
        internal void DrawIcons(Graphics g)
        {
            ...
            {
                new Point(nLeft + 3 + 16 - arrowMargin, nTop + arrowMargin),
                new Point(nLeft + 3 + arrowMargin, nTop + 8),
                new Point(nLeft + 3 + 16 - arrowMargin, nTop + 16 - arrowMargin),
            };
            Point[] rightArrow = new Point[]
            {
                new Point(nMiddle - 3 + nLeft + arrowMargin, nTop + arrowMargin),
                new Point(nMiddle - 3 + nLeft + 16 - arrowMargin, nTop + 8),
                new Point(nMiddle - 3 + nLeft + arrowMargin, nTop + 16 - arrowMargin),
            };
            ...
            if (this.TabCount > 0)
            {
                ...
                Brush leftArrowBrush = r3.Left < TabControlArea.Left ? new SolidBrush(ForeColor) : new SolidBrush(ThemeSwitcher.ProjectTheme.TextColorDisabled);
                r3 = this.GetTabRect(this.TabCount - 1);
                Brush rightArrowBrush = r3.Right > (TabControlArea.Width - r0.Width) ? new SolidBrush(ForeColor) : new SolidBrush(ThemeSwitcher.ProjectTheme.TextColorDisabled);

                g.FillPolygon(leftArrowBrush, leftArrow);
                g.FillPolygon(rightArrowBrush, rightArrow);

                leftArrowBrush.Dispose();
                rightArrowBrush.Dispose();
            }
            //----------------------------
        }
